...
之后, 我们通过 [solscan.io](https://solscan.io/) 查询当日 sol 的总供应量. 得知截至 2025 年 9 月 2 日, sol 的总供应量为 608,757,550 枚(包含流通供应量 540,915,225 枚以及非流通供应量). 也就是说, 在经历 5.5 年的运营之后, 市面上流通的绝大部分 sol (500,000,000 / 540,915,225 = 92.4%) 仍然都来自创世块. 根据这个信息我们可以至少得到两个有用的分析:
