...
我现在已经有了一个 pxs 代币, 现在我准备让它和 sol 进行交易, 我需要为这两个代币创建一个池子. 在网页上的操作步骤十分简单:
...
由于我为自己的代币提供了流动性, raydium 会为我发放 lp token, 这些代币代表我在流动性池中的份额. 您应当妥善保管这些 lp token, 当您试图撤出流动性时需要提供这些 lp token.
...
在后续章节中, 我会实现一个关于 pxs 代币的空投合约. 您可以领取免费的空投并在此池子中换取 sol.
