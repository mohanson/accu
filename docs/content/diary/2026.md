...
I had a great lunar new year with my family.

My mother's illness seems to be getting better, which is a relief.

**03 月 22 日**

自上一次去上海已经是五年前了. 这次去参加 solana 的活动. 上海的交通系统非常拥挤, 车道狭小, 多数时候我们都在地下路网里穿行, 像是穴居的小生物.

**03 月 28 日**

I went to the lake to catch fish today, but unfortunately most of the fish were still hibernating.

**04 月 14 日**

你喜欢讨论一些已经有定论的东西, 而不是去学习并接受它的定论, 不仅浪费时间, 还显得很无知.
...
前往临安太湖源的 S218 省道居然在改建, 把我以前常去的一个摸鱼抓虾圣地给拆没了, 真是太可惜了.

**06 月 28 日**

这个月宝可梦冠军发布了手机版, 我手机安卓版本太低, 无法安装. 于是只能在电脑上安装了 bluestacks 安卓模拟器, 但又遇到了网络问题, 因为无法访问谷歌服务, 无法下载和登录游戏. 试了很多方法, 最后找到一个最简单的方案, 通过 adb 命令设置代理服务器, 让bluestacks 可以访问谷歌服务.

一. 在设置界面打开 adb 调式:

![img](../../img/diary/2026/bluestacks_settings.jpg)

二. 在电脑上[下载 adb 工具](https://developer.android.com/tools/releases/platform-tools), 进入 adb 所在目录, 执行以下命令, 这个时候模拟器内部网络会走主机上部署在 1080 端口的的代理服务器. 其中 10.0.2.2 是个特殊的 ip 地址, 代表宿主机.

```sh
$ adb connect 127.0.0.1:5555
$ adb devices

$ adb shell settings put global http_proxy  10.0.2.2:1080
$ adb shell settings put global https_proxy 10.0.2.2:1080
```

![img](../../img/diary/2026/bluestacks_google_play.jpg)

玩了几天, 上了大师球级别!

![img](../../img/diary/2026/bluestacks_champion.jpg)

**07 月 16 日**

![img](../../img/diary/2026/sunset.jpg)
